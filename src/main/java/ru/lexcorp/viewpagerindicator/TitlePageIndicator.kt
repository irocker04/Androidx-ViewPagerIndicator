...
class TitlePageIndicator(
    ...
    defStyle: Int = R.attr.vpiTitlePageIndicatorStyle
) :
    ...
    enum class IndicatorStyle constructor(val value: Int) {
    ...
    enum class LinePosition constructor(val value: Int) {
        Bottom(0), Top(1);
    ...
    init {
        run {
            ...
            val res = resources
            val defaultFooterColor = ContextCompat.getColor(context, R.color.default_title_indicator_footer_color)
            ...
            val defaultFooterIndicatorUnderlinePadding =
            ...
            val defaultSelectedColor = ContextCompat.getColor(context, R.color.default_title_indicator_selected_color)
            val defaultSelectedBold = res.getBoolean(R.bool.default_title_indicator_selected_bold)
            val defaultTextColor = ContextCompat.getColor(context, R.color.default_title_indicator_text_color)
...
//        }
    ...
    private fun getTitle(i: Int): CharSequence {
        var title = mViewPager!!.adapter!!.getPageTitle(i)
        if (title == null) {
            title = EMPTY_TITLE
        }
        return title
    ...
    companion object {
         ...
         */
        private const val SELECTION_FADE_PERCENTAGE = 0.25f
         ...
         */
        private const val BOLD_FADE_PERCENTAGE = 0.05f
